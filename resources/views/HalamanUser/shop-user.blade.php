                    ...
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu">
                            <ul>
                                ...
                                <li class="current-list-item"><a href="{{ route('shop-user') }}">Shop</a></li>
    ...
    <div class="product-section mt-150 mb-150">
        <div class="container">
                ...
                <div class="col-md-12">
                    <div class="product-filters">
                        <ul id="kategori-filter">
                            ...
                            {{-- Asumsi $kategori sudah tersedia dari Controller --}}
            ...
            <div class="row product-lists" id="product-container">
                {{-- Asumsi 'HalamanUser.partials.product-list' di-include di sini --}}
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="pagination-wrap" id="pagination-container">
                        {{-- Asumsi $produk adalah instance paginator --}}
